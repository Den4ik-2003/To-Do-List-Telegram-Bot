"""
ЗМІНЕНИЙ ФАЙЛ: keyboards/main_menu.py

Єдина зміна відносно оригіналу — до CATEGORY_LIFE додано пункт "🍳 Кухня".
Решта (структура категорій, розмір клавіатур, кнопка "⬅️ Головне меню") —
без змін.
"""
